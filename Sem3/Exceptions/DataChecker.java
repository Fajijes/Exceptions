...
public class DataChecker {
    ...
    public void CheckData(String[] splitedString) throws ParsingData {
        ...
        if (!fullErrorsMessages.isEmpty()) {
            throw new ParsingData(fullErrorsMessages.toString());
        }
    }
    ...
    private String checkFIO(String inputString) throws NameException {
